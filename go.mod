...
require (
	...
	github.com/bakito/go-log-logr-adapter v0.0.3-0.20231211113354-bfa42fa7e121 // indirect
	...
	sigs.k8s.io/gateway-api v1.0.1-0.20240229112436-da26d60306e1 // indirect
